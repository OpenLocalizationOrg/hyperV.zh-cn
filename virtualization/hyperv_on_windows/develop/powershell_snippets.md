...
See a list of available VMs with `Get-VM`  
`$cred` -- Credential for the guest OS.
...
4. Code your credentials into your scripts.
    **Don't do this for any real workload or system**
    > Warning:  _Do not do this in a production system.
    > Do not do this with real passwords._
